...
//   src=${preview} data-source=${original} data-name=${currentNum++} alt=${description}/></a></li>`;
// }).join('');

// gallery.innerHTML = newArr;

// const jsLightbox = document.querySelector('ul[class="gallery js-gallery"]');
// const lightboxImage = document.querySelector('img[class="lightbox_image"]');
// const buttonClose = document.querySelector('button[class="lightbox_button"]');
